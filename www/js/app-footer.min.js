 ...
 * www/js/app.js
 */
window.APP_CONFIG={"REPOSITORY_ALT_URL":null,"SERVER_PROJECT_PATH":"/home/ubuntu/apps/books15","DEPLOY_TO_SERVERS":false,"S3_DEPLOY_URL":null,"DEPLOY_SERVICES":false,"NPR_DFP":{"ENVIRONMENT":"NPRTEST","STORY_ID":"1002","TARGET":"homepage","TESTSERVER":"false"},"VIZ_GOOGLE_ANALYTICS":{"ACCOUNT_ID":"UA-5828686-75"},"NPR_GOOGLE_ANALYTICS":{"TOPICS":"[1032,1008,1002]","DOMAIN":"apps.npr.org","ACCOUNT_ID":"UA-5828686-4"},"LINK_CATEGORY_MAP":{"Book Reviews":"Review","Author Interviews":"Interview"},"COPY_PATH":"data/copy.xlsx","GITHUB_USERNAME":"nprapps","DISQUS_API_KEY":"tIbSzEhGBE9NIptbnQWn4wy1gZ546CsQ2IHHtxJiYAceyyPoAkDkVnQfCifmCaQW","DEFAULT_MAX_AGE":20,"ASSETS_MAX_AGE":20,"ASSETS_S3_BUCKET":"movement-2016","REPOSITORY_NAME":"books15","DISQUS_SHORTNAME":"nprviz-test","STAGING_S3_BUCKET":"stage-apps.npr.org","PROJECT_SLUG":"best-books-2015","PRODUCTION_SERVERS":["cron.nprapps.org"],"SERVERS":[],"LINK_CATEGORY_DEFAULT":"Feature","SERVER_SERVICES":[["app","/home/ubuntu/apps/books15/repository","ini"],["uwsgi","/etc/init","conf"],["nginx","/etc/nginx/locations-enabled","conf"]],"SERVER_BASE_URL":"http://127.0.0.1:8001/best-books-2015","REPOSITORY_URL":"git@github.com:nprapps/books15.git","RELOAD_CHECK_INTERVAL":60,"GOOGLE_OAUTH_CREDENTIALS_PATH":"~/.google_oauth_credentials","PRODUCTION_S3_BUCKET":"apps.npr.org","SERVER_VIRTUALENV_PATH":"/home/ubuntu/apps/books15/virtualenv","S3_BASE_URL":"http://127.0.0.1:8000","S3_BUCKET":null,"DEPLOY_CRONTAB":false,"ASSETS_SLUG":"books15","SERVER_PYTHON":"python2.7","DEBUG":true,"STAGING_SERVERS":["cron-staging.nprapps.org"],"RELOAD_TRIGGER":false,"SERVER_USER":"ubuntu","COPY_GOOGLE_DOC_KEY":"1b57DbxWH6f08ZIZqPuMozeeRoc6u8LNVLcjrZQ4ptrY","DATA_GOOGLE_DOC_KEY":"1ToCIpyTa7Szh6H7UfVm876lmq03qod8LG4pVC78eJ1w","PROJECT_FILENAME":"books15","SERVER_REPOSITORY_PATH":"/home/ubuntu/apps/books15/repository","DISQUS_UUID":"0af7f82b-832a-11e5-8a04-3c07544df4b5","SHARE_URL":"http://apps.npr.org/best-books-2015/","UWSGI_SOCKET_PATH":"/tmp/books15.uwsgi.sock","SERVER_LOG_PATH":"/tmp","DEPLOYMENT_TARGET":null};
...
window.COPY={"rename":[{"title":"This is a test","url":null,"genre":"science fiction","author":"Margie"}],"attribution":{"byline":"contact ","header_subhead":"How you can get involved and support key movements in 2016"},"tags":{"501c3":"501c3","501c4":"501c4","PAC":"PAC","African-American":"African-American","Climate-Justice":"Climate Justice","Criminal-Justice":"Criminal Justice","Faith":"Faith","Immigrant-Rights":"Immigrant Rights","Latino":"Latino","Racial-Justice":"Racial Justice","Statewide":"Statewide","Voter-Turnout":"Voter Turnout","Youth":"Youth","Arizona":"Arizona","Arkansas":"Arkansas","California":"California","Colorado":"Colorado","Connecticut":"Connecticut","Florida":"Florida","Georgia":"Georgia","Hawaii":"Hawaii","Illinois":"Illinois","Indiana":"Indiana","Iowa":"Iowa","Kansas":"Kansas","Kentucky":"Kentucky","Louisiana":"Louisiana","Maine":"Maine","Maryland":"Maryland","Massachusetts":"Massachusetts","Michigan":"Michigan","Minnesota":"Minnesota","Missouri":"Missouri","Montana":"Montana","Nebraska":"Nebraska","Nevada":"Nevada","New-Hampshire":"New Hampshire","New-Jersey":"New Jersey","New-Mexico":"New Mexico","New-York":"New York","North-Carolina":"North Carolina","Ohio":"Ohio","Oregon":"Oregon","Pennsylvania":"Pennsylvania","South-Dakota":"South Dakota","Texas":"Texas","Virginia":"Virginia","Washington":"Washington","West Virginia":"West Virginia","Wisconsin":"Wisconsin"},"share":{"meta_description":"TKTK","share_url":"http://TKTK","twitter_handle":"@nprviz","twitter_text":"TKTK","twitter_image_url":"http://TKTK","facebook_title":"TKTK","facebook_text":"TKTK","facebook_image_url":"http://TKTK","facebook_app_id":"1.38837436155e+14","google_news_image_url":"http://TKTK","featured_tweet1":"","featured_tweet2":"","featured_tweet3":"","featured_facebook1":"","featured_facebook2":"","featured_facebook3":"","story_summary":"TKTK","email_subject":"TKTK","email_body":"TKTK%0D%0A%0D%0Ahttp://TKTK%0D%0A%0D%0AFrom NPR","comment_prompt":"Leave a comment"},"content":{"project_name":"Movement Concierge","byline":"Billy Wimsatt","pubdate":"1/22/2013 (TKTK)","lorem_ipsum":"Lorem ipsum dolor sit amet, <strong>consectetur adipisicing elit</strong>, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.","footer_title":"This content goes to 12","header_title":"Movement 2016 Concierge","dedication":"How you can get involved and support key movements in 2016","clear_filters":"Clear Filters!","header_subhead":"Get involved and support key movements in 2016","chatter":"Use the filters below to explore Movement2016 organizations. (You can also combine filters!)","contact_us":"Contact Us"},"example_list":[{"term":"jabberwocky","definition":"Invented or meaningless language; nonsense."},{"term":"Antioch","definition":"Land of the Holy Hand Grenade."},{"term":"swallow","definition":"What kind?"}]};
...
(function(){window.JST||(window.JST={});window.JST.book_grid_item=function(obj){var __p='';var print=function(){__p+=Array.prototype.join.call(arguments,'');};with(obj||{}){__p+='\n\n<div id="'+(book.slug)+'" class="book card isotope-item ';_.each(book.tags,function(tag){;__p+='tag-'+tag+' ';});__p+=' isotope-hidden no-touch" data-sort="'+loop_index+'">\n    <a href="#/book/'+(book.slug)+'">\n    <div class="book-outer-wrapper" style="pointer-events: none;">\n        <!-- Book Image -->\n       ';if(book.teaser){;__p+='\n        <div class="review hover">'+(book.teaser)+'<br /><div class="reviewer hover"><span class="reviewer-span">Read <strong>'+(book.reviewer)+'\'';if(book.reviewer[book.reviewer.length-1]!='s'){;__p+='s';};__p+='</strong> full recommendation &raquo;</span></div></div>\n        ';};__p+='\n      <header>\n        <h2>'+(book.title)+'</h2>\n      </header>\n      <article><p>'+(book.text)+'</p></article>\n      <!--img src="assets/img/cover-loading.gif" data-src="assets/cover/'+(book.slug)+'.jpg" alt="'+(book.title)+'"/-->\n    </div>\n    </a>\n</div>\n                    \n';}return __p;};window.JST.book_list_item=function(obj){var __p='';var print=function(){__p+=Array.prototype.join.call(arguments,'');};with(obj||{}){__p+='\n<li class="visible ';_.each(book.tags,function(tag){;__p+='tag-'+tag+' ';});__p+=' '+(book.slug)+'" data-sort="'+loop_index+'" data-slug="'+(book.slug)+'">\n    <a href="#/book/'+(book.slug)+'">\n        <span class="title">'+(book.title)+'</span><br />\n        <span class="author">by&nbsp;'+(book.author)+'</span>\n    </a><br />\n</li>';}return __p;};window.JST.book_modal=function(obj){var __p='';var print=function(){__p+=Array.prototype.join.call(arguments,'');};with(obj||{}){__p+='<div class="modal-header hide">\n    <!-- <a class="hide npr-logo" href="http://npr.org/books/"><img src="http://media.npr.org/chrome/books/npr-books-logo-color.png" alt="NPR Books" /></a> -->\n    <a href="#" class="hide mobile-dismiss" data-dismiss="modal" aria-hidden="true"><i class="icon-left-open"></i> Back to NPR&rsquo;s Book Concierge</a>\n    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>\n</div>\n<div class="modal-body-wrapper">\n    <a class="paddle" href="#/book/'+previous+'" id="previous-book">\n        ';if(previous!=null){;__p+='\n        <span class="icon-left-open"></span>\n        ';};__p+='\n    </a>\n    <div class="modal-body-inner">\n        <div class="modal-body clearfix">\n            <div class="modal-book-cover">\n                <img id="book-image" src="assets/cover/'+(book.slug)+'.jpg" alt="'+(book.title)+'"/>\n            </div>\n\n            <div class="modal-text">\n                <h4 class="modal-title" id="myModalLabel">'+(book.title)+'</h4>\n                ';if(book.author){;__p+='<p class="author">By '+(book.author)+'</p> ';};__p+='\n                ';if(book.genre){;__p+='<p class="genre"><strong>'+(COPY.content.genre)+' </strong>'+(book.genre)+'</p> ';};__p+='\n\n                <!-- Tags -->\n                ';if(book.tags.length>0){;__p+='<p class="tags">';_.each(book.tags,function(tag,index,list){;__p+='\n                    <a\n                        class="btn btn-large btn-info tag '+tag+'"\n                        href="#/tag/'+tag+'">'+COPY.tags[tag]+'\n                    </a>\n                ';});;__p+='</p> ';};__p+='\n\n                <!-- Book Description/Review -->\n                ';if(book.text&&!book.html_text){;__p+='<p class="text">'+(book.text)+'</p> \n                ';}else if(book.text&&book.html_text){;__p+=''+(book.text)+'\n                ';};__p+='\n                ';if(book.reviewer){;__p+='<p class="reviewer">&mdash; '+(COPY.content.recommended_by)+' <strong>';if(book.reviewer_link){;__p+='<a href="'+book.reviewer_link+'" target="_blank">'+(book.reviewer)+'</a>';}else{;__p+=''+(book.reviewer)+'';};__p+='</strong>';if(book.reviewer_id){;__p+=', '+book.reviewer_id+'';};__p+='</p> ';};__p+='\n\n                <!-- Purchase/Related Links -->\n\n                <p class="book-modal-links">\n                    ';if(book.oclc){;__p+='\n                    <!--a href="http://www.worldcat.org/oclc/'+(book.oclc)+'" target="_blank" class="purchase-link" onclick="ANALYTICS.trackEvent(\'library\', \''+(book.slug)+'\');"><i class="icon icon-bank"></i>Find at your library</a>\n                    ';};__p+='\n                    <a href="http://www.amazon.com/dp/'+(book.isbn)+'?tag=npr-5-20" target="_blank" class="purchase-link shopping-cart" onclick="ANALYTICS.trackEvent(\'amazon\', \''+(book.slug)+'\');">Amazon</a>\n                    ';if(book.hide_ibooks!='TRUE'){;__p+='\n                    <a href="https://itunes.apple.com/us/book/isbn'+(book.isbn13)+'?&at=11l79Y" target="_blank" class="purchase-link shopping-cart" onclick="ANALYTICS.trackEvent(\'ibooks\', \''+(book.slug)+'\');">iBooks</a>\n                    ';};__p+='\n                    <a href="http://www.indiebound.org/book/'+(book.isbn13)+'?aff=NPR" target="_blank" class="purchase-link shopping-cart" onclick="ANALYTICS.trackEvent(\'indiebound\', \''+(book.slug)+'\');">Independent&nbsp;Booksellers</a>\n                </p-->\n\n                ';if(book.links){;__p+='\n                <ul>\n                    ';_.each(book.links,function(link){;__p+='\n                    <li class="book-modal-links">\n                        <a href="'+(link.url)+'" target="_blank">\n                            <strong>\n                            ';if(link.category){;__p+=''+(link.category)+'';if(link.title){;__p+=':';};__p+='';}else{;__p+='Feature:';};__p+='\n                            </strong>\n                            '+(link.title)+'\n                        </a>\n                    </li>\n                    ';});__p+='\n                </ul>\n                ';};__p+='\n            </div>\n        </div>\n\n        <div class="modal-footer">\n            <div class="social">\n                <p>Share Review:</p>\n                <a href="mailto:?body='+(encodeURIComponent(APP_CONFIG.S3_BASE_URL+"#/book/"+book.slug+'\n\n"'+book.text.replace(/(<([^>]+)>)/ig,"")+'"\n\n--'+book.reviewer+', '+book.reviewer_id.replace(/(<([^>]+)>)/ig,"")))+'&amp;subject='+(encodeURIComponent("NPR's best books of 2014 - "+book.title))+'" onclick="_gaq.push([\'_trackEvent\', \''+(APP_CONFIG.PROJECT_SLUG)+'\', \'email\', \''+(book.slug)+'\']);">\n                    <div class="share-button">\n                        <span class="icon icon-mail"></span>\n                    </div>\n                </a>\n\n                <a href="https://twitter.com/share?text='+(encodeURIComponent('Look what I found on @NPRBooks\' #bookconcierge: '+book.title))+'&amp;url='+(encodeURIComponent(APP_CONFIG.S3_BASE_URL+"/share/"+book.slug+".html"))+'" target="_blank" onclick="_gaq.push([\'_trackEvent\', \''+(APP_CONFIG.PROJECT_SLUG)+'\', \'twitter\', \''+(book.slug)+'\']);">\n                    <div class="share-button">\n                        <span class="icon icon-twitter"></span>\n                    </div>\n                </a>\n                <a href="https://www.facebook.com/dialog/feed?app_id='+(COPY.share.facebook_app_id)+'&amp;link='+(encodeURIComponent(APP_CONFIG.S3_BASE_URL+"/share/"+book.slug+".html"))+'&amp;redirect_uri='+(encodeURIComponent(APP_CONFIG.S3_BASE_URL+"#book/"+book.slug))+'" target="_blank" onclick="_gaq.push([\'_trackEvent\', \''+(APP_CONFIG.PROJECT_SLUG)+'\', \'facebook\', \''+(book.slug)+'\']);">\n                    <div class="share-button">\n                        <span class="icon icon-facebook"></span>\n                    </div>\n                </a>\n                <a href="https://pinterest.com/pin/create/button/?url='+(encodeURIComponent(APP_CONFIG.S3_BASE_URL+"/share/"+book.slug+".html"))+'&amp;media='+(encodeURIComponent(APP_CONFIG.S3_BASE_URL+"/assets/cover/"+book.slug+".jpg"))+'" target="_blank" onclick="_gaq.push([\'_trackEvent\', \''+(APP_CONFIG.PROJECT_SLUG)+'\', \'pinterest\', \''+(book.slug)+'\']);">\n                    <div class="share-button">\n                    <span class="icon icon-pinterest-circled"></span>\n                    </div>\n                </a>\n            </div>\n            <div class="hide book-nav">\n                ';if(previous!=null){;__p+='\n                <a href="#/book/'+previous+'" class="btn btn-default modal-nav-buttons" id="previous-book">PREVIOUS BOOK</a>\n                ';};__p+='\n                ';if(next!=null){;__p+='\n                <a href="#/book/'+next+'" class="btn btn-default modal-nav-buttons" id="next-book">NEXT BOOK</a>\n                ';};__p+='\n            </div>\n            <button type="button" class="btn btn-default" id="modal-close-btn" data-dismiss="modal">&times; <em>Close</em></button>\n        </div>\n    </div>\n\n    <a class="paddle" href="#/book/'+next+'" id="next-book">\n        ';if(next!=null){;__p+='\n        <span class="icon-right-open"></span>\n        ';};__p+='\n    </a>\n</div>\n\n\n';}return __p;};window.JST.example=function(obj){var __p='';var print=function(){__p+=Array.prototype.join.call(arguments,'');};with(obj||{})__p+='<p>This project is is running with the following settings:</p>\n\n<pre>\n'+config+'    \n</pre>\n\n<p>This project has the following COPY configured:</p>\n\n<pre>\n'+copy+'\n</pre>\n\n<p>This text is rendered from a template found at <code>'+template_path+'</code>.</p>\n';return __p;};})();
var MOBILE=Modernizr.touch;var SMALL=Modernizr.mq('only all and (max-width: 480px)');var $body;var $content;var $books_grid;var $all_tags;var $tags={};var $clear_tags;var $current_tag;var $modal;var $modal_content;var $books_list;var $back_to_top;var $mobile_filters_btn;var $filter;var $toggle_text;var $show_text_button;var $show_books_button;var $review;var $first;var $last;var $share_modal;var $large_ad;var $header;var next;var previous;var selected_tags=[];var first_hash=true;var scroll_to=function($el){var top=$el.offset().top;$body.scrollTop(top);};var back_to_top=function(){$body.scrollTo($content,{duration:450},'y');return false;};var isotope_grid=function(filter){$books_grid.isotope({filter:filter,transitionDuration:(!MOBILE)?'0.4s':0,getSortData:{'id':function(el){return parseInt($(el).data('sort'),10);}},sortBy:'id'});};var filter_books=function(){$all_tags.parent().removeClass('selected unavailable');$all_tags.removeClass('selected unavailable');selected_tags.sort();if(selected_tags.length>0){var filter='';var label=[];for(var i in selected_tags){var slug=selected_tags[i];$tag=$tags[slug];$tag.addClass('selected');$tag.parent().addClass('selected');filter+='.tag-'+slug;label.push(COPY.tags[slug]);}label=label.join(', ');var remaining_books=_.filter(BOOKS,function(book){for(var i in selected_tags){var slug=selected_tags[i];if(_.indexOf(book.tags,slug)==-1)return false;}return true;});for(var tag_slug in COPY.tags){var has_results=false;for(var z=0;z<remaining_books.length;z++){var book=remaining_books[z];if(_.indexOf(book.tags,tag_slug)>=0){has_results=true;break;}}if(!has_results){$tag=$tags[tag_slug];$tag.parent().addClass('unavailable');$tag.addClass('unavailable');}}$clear_tags.removeClass('hide');$current_tag.find('#showing-span').text('Showing books tagged ');$current_tag.find('#tag-span').text(label);$books_grid.removeClass('filter-inactive');filter_books_list(filter);_.defer(isotope_grid,filter);}else{$clear_tags.addClass('hide');$current_tag.find('#showing-span').text('Showing all books');$current_tag.find('#tag-span').text('');$books_grid.addClass('filter-inactive');filter_books_list(null);_.defer(isotope_grid,'*');}_.delay(function(){$(window).trigger('scroll');},1000);};var filter_books_list=function(filter){if(filter){$books_list.find('li').removeClass('visible');filter='';for(var i in selected_tags){var slug=selected_tags[i];filter+='.tag-'+slug;}$books_list.find(filter).addClass('visible');}else $books_list.find('li').addClass('visible');};var on_tag_clicked=function(){var slug=$(this).data('tag-slug');var already_selected=selected_tags.indexOf(slug);if(already_selected>=0)selected_tags.splice(already_selected,1);else selected_tags.push(slug);if(selected_tags.length>0)hasher.setHash('tag',selected_tags.join(','));else hasher.setHash('_');toggle_filter_modal();return false;};var on_page_scroll=function(){var y_scroll_pos=window.pageYOffset;var scroll_pos_test=1200;if(y_scroll_pos>scroll_pos_test&&$('#myModal:visible').length===0)$back_to_top.fadeIn(1000);else $back_to_top.fadeOut(400);};var on_modal_tag_clicked=function(){back_to_top();return true;};var on_clear_tags_clicked=function(){hasher.setHash('_');ANALYTICS.trackEvent('clear-tags');return false;};var on_tag_hash=function(tags){selected_tags=tags.split(',');filter_books();};var on_book_hash=function(slug){$modal_content.empty();book=_.find(BOOKS,function(book){return book.slug==slug;});var grid_item;if($books_grid.is(':visible')){grid_item=$('#'+book.slug);if($books_grid.hasClass('filter-inactive')){next=grid_item.next();previous=grid_item.prev();$first=$books_grid.find('.book').first();$last=$books_grid.find('.book').last();}else{next=grid_item.nextAll(':visible').first();previous=grid_item.prevAll(':visible').first();$first=$books_grid.find('.book:visible').first();$last=$books_grid.find('.book:visible').last();}if(next.length===0)next=$first.attr('id');else next=next.attr('id');if(previous.length===0)previous=$last.attr('id');else previous=previous.attr('id');}else{grid_item=$('li.'+book.slug);next=grid_item.nextAll(':visible').first();previous=grid_item.prevAll(':visible').first();$first=$books_list.find('li:visible').first();$last=$books_list.find('li:visible').last();if(next.length===0)next=$first.attr('data-slug');else next=next.attr('data-slug');if(previous.length===0)previous=$last.attr('data-slug');else previous=previous.attr('data-slug');}$modal_content.append(JST.book_modal({book:book,next:next,previous:previous,SMALL_MOBILE:(SMALL&&MOBILE)}));$modal.scrollTop(0);$modal.modal();$back_to_top.hide();};var on_hash_changed=function(new_hash,old_hash){var bits=new_hash.split('/');var hash_type=bits[0];var hash_slug=bits[1];if(new_hash=='_')new_hash='';if(hash_type=='tag'){$modal.modal('hide');on_tag_hash(hash_slug);selected_tags.sort();ANALYTICS.trackEvent('selected-tags',selected_tags.join(','));}else if(hash_type=='book'){on_book_hash(hash_slug);$modal.show().css('overflow-y','hidden').scrollTop(0).css('overflow-y','scroll');if(new_hash!='')ANALYTICS.trackEvent('view-review',hash_slug);if(first_hash)filter_books();}else{$modal.modal('hide');selected_tags=[];filter_books();}if(selected_tags.length>0)$mobile_filters_btn.text('Add more filters');else $mobile_filters_btn.text('Filter by tags');first_hash=false;return false;};var on_book_modal_closed=function(){if(selected_tags.length>0)hasher.setHash('tag',selected_tags.join(','));else hasher.setHash('_');return true;};var relayout=_.throttle(function(){$books_grid.isotope('layout');},500);var unveil_grid=function(){$books_grid.find('img').unveil(500,function(){$(this).imagesLoaded(function(){relayout();});});};var toggle_filter_modal=function(){$filter.toggleClass('hidden-xs').scrollTop(0);};var toggle_books_list=function(){$books_grid.toggle();$books_list.toggle();$toggle_text.toggleClass('grid-active list-active');if($books_grid.is(':visible')){ANALYTICS.trackEvent('toggle-view','grid');filter_books();}else ANALYTICS.trackEvent('toggle-view','list');};var on_next=function(){ANALYTICS.trackEvent('navigate','next');};var on_previous=function(){ANALYTICS.trackEvent('navigate','previous');};var on_keypress=function(e){if($('#myModal:visible').length>0)if(e.which===37&&previous!==null){on_previous();hasher.setHash('book',previous);}else if(e.which===39&&next!==null){on_next();hasher.setHash('book',next);}};var on_show_share=function(){ANALYTICS.trackEvent('open-share-discuss');};var on_hide_share=function(){ANALYTICS.trackEvent('close-share-discuss');};var resize=function(){var height=$header.outerHeight();$large_ad.height(height);};var onClippyCopy=function(e){alert('Copied to your clipboard!');ANALYTICS.trackEvent('summary-copied');};$(function(){$body=$('body');$content=$('#content');$books_grid=$('#books-grid');$all_tags=$('.tags .tag');$clear_tags=$('.clear-tags');$current_tag=$('.current-tag');$modal=$('#myModal');$modal_content=$('#myModal .modal-content');$books_list=$('#books-list');$back_to_top=$('#back-to-top');$mobile_filters_btn=$('#mobile-filters');$filter=$('.filter.tags');$show_text_button=$('.show-text');$show_books_button=$('.show-books');$toggle_text=$('.toggle-text');$review=$('.review');$share_modal=$('#share-modal');$large_ad=$('#largeVersion');$header=$('#top');window.BOOKS=_.shuffle(window.BOOKS);_.each(window.BOOKS,function(book,i){var book_grid_content=window.JST.book_grid_item({book:book,loop_index:i});$books_grid.append(book_grid_content);});window.BOOKS_SORTED=_.sortBy(_.map(window.BOOKS,function(book){if(book.title.slice(0,4).toLowerCase()==='the ')book.sort_title=book.title.slice(4,book.title.length);else if(book.title.slice(0,2).toLowerCase()=='a ')book.sort_title=book.title.slice(2,book.title.length);else book.sort_title=book.title;return book;}),'sort_title');_.each(window.BOOKS_SORTED,function(book,i){var book_list_content=window.JST.book_list_item({book:book,loop_index:i});$books_list.append(book_list_content);});$body.on('click','.filter .tag',on_tag_clicked);$content.on('click','.back-to-top',back_to_top);$content.on('click','button.clear-tags',on_clear_tags_clicked);$modal.on('hidden.bs.modal',on_book_modal_closed);$modal.on('click','.tag',on_modal_tag_clicked);$back_to_top.on('click',back_to_top);$mobile_filters_btn.on('click',toggle_filter_modal);$filter.find('.close-modal').on('click',toggle_filter_modal);$toggle_text.on('click',toggle_books_list);$(window).on('scroll',on_page_scroll);$modal.keyup(on_keypress);$modal.on('click','#previous-book',on_previous);$modal.on('click','#next-book',on_next);$share_modal.on('shown.bs.modal',on_show_share);$share_modal.on('hidden.bs.modal',on_hide_share);$(window).on('resize',resize);resize();$back_to_top.hide();$current_tag.find('#showing-span').text('Showing all books');$current_tag.show();_.each($all_tags,function(tag){var $tag=$(tag);$tags[$tag.data('tag-slug')]=$tag;});ZeroClipboard.config({swfPath:'js/lib/ZeroClipboard.swf'});var clippy=new ZeroClipboard($(".clippy"));clippy.on('ready',function(readyEvent){clippy.on('aftercopy',onClippyCopy);});hasher.changed.add(on_hash_changed);hasher.initialized.add(on_hash_changed);hasher.init();_.delay(unveil_grid,0);});